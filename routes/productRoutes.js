...
import { addProduct, getProduct, getProductByCategory, getProducts, getTop5, removeProduct, reviewProduct, updateProduct } from '../controllers/productController.js';
...
router.route('/category/:category').get(getProductByCategory).all(notAllowed);
